...
namespace UberApi.Models.DataManager
{
    ...
    public class EtablissementManager : IDataRepository<Etablissement>
    {
        ...
        {
            return await s221UberContext.Etablissements.Include(a => a.IdRestaurateurNavigation).Include(r => r.IdAdresseNavigation).ThenInclude(e => e.IdVilleNavigation).FirstOrDefaultAsync(u => u.IdEtablissement == id);
        }
